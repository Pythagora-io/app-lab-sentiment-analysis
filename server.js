...
const aspectRoutes = require('./routes/aspectRoutes');
const User = require('./models/User'); // Added for user information middleware
...
// Feedback Routes
app.use(feedbackRoutes); // Implementing feedback routes
